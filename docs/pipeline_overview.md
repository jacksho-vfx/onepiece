...
| **Render & compute** | Submit jobs to farms, monitor completions. | Control-plane scheduling with feedback loops to dashboards and chatops. | `onepiece render submit`, farm adapters, Trafalgar render API, Uta render monitor panels. |
