...
def list_variants(
    ...
    """List variants available to Maya users for the current stage."""
...
def switch_variant(
    ...
    *,
    ...
    """Switch a variant in Maya and trigger a viewport refresh."""
...
def _noop_refresh() -> None:
    # Maya implementations can override this to call cmds.refresh or viewport APIs.
    return None
