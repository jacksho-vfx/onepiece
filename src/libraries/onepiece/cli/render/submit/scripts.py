...
def _panel_template(dcc: str, farm: str, profile: str | None) -> str:
    ...
    return dedent(
        ...
        from libraries.onepiece.cli.render.submit.scripts import run_render_submission
...
def _menu_template(dcc: str, farm: str, profile: str | None) -> str:
    ...
    return dedent(
        ...
        from libraries.onepiece.cli.render.submit.scripts import (
...
def _optimization_template(dcc: str, farm: str, profile: str | None) -> str:
    ...
    return dedent(
        ...
        from libraries.onepiece.cli.render.submit.scripts import optimisation_preview
...
def _sanity_template() -> str:
    ...
    return dedent(
        ...
        from libraries.onepiece.cli.render.submit.scripts import sanity_check_submission
