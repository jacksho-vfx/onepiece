...
# from apps.onepiece.shotgrid import deliver
#
# runner = CliRunner()
#
#
...
#     monkeypatch.setattr(deliver, "ShotgridClient", lambda: stub_client)  # ✅ patch module
...
#
#     monkeypatch.setattr(deliver, "s5_sync", _fake_sync)  # ✅ patch module
#
...
#
#     stub_client = StubShotgridClient(versions)
#     monkeypatch.setattr(deliver, "ShotgridClient", lambda: stub_client)
#     monkeypatch.setattr(deliver, "s5_sync", lambda *args, **kwargs: None)
#
#     output = tmp_path / "delivery.zip"
#     result = _invoke_cli(
#         [
...
#         sync_calls.append((sync_dir, destination))
#
#     monkeypatch.setattr(deliver, "s5_sync", _fake_sync)
#
#     output = tmp_path / "delivery.zip"
