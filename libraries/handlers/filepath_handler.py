...
from onepiece.libraries.handlers.protocols import FilepathHandlerProtocol
...
class FilepathHandler(FilepathHandlerProtocol):
    ...
    def __init__(self, root: Optional[UPath] = None) -> None:
        self.root = UPath(root or "/mnt/projects").resolve()
    ...
    # --- Utility ------------------------------------------------------------ #
    def _ensure(self, path: UPath) -> UPath:
        """
