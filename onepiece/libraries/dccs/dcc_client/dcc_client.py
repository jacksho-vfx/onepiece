...
def batch_open_scenes(
    dcc: SupportedDCC, scene_files: list[Path], dry_run: bool = False
):
...
def publish_scene(
    dcc: SupportedDCC, source: Path, target: Path, metadata: dict | None = None
):
    """
...
def create_scene_metadata(
    project_id: int, episode: str, scene: str, shot: str, asset: str | None = None
) -> dict:
    """
